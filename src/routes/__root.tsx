...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Book 200+ hotels, studios and villas on Thassos Island. Free ferry tickets with every booking. Curated by Thassos HORECA." },
      { name: "theme-color", content: "#0f0b09" },
      { property: "og:title", content: "Thassos Accommodation — Thassos HORECA" },
      { property: "og:description", content: "200+ hotels on Thassos Island with free ferry tickets on every booking." },
